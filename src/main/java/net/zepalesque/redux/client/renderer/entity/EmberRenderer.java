...
public class EmberRenderer extends EntityRenderer<Ember> {
    ...
    public void render(Ember entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        vertex(vertexconsumer, posestack$pose, light, -radius, -radius, 0, 1, alpha);
        vertex(vertexconsumer, posestack$pose, light, radius, -radius, 1, 1, alpha);
        vertex(vertexconsumer, posestack$pose, light, radius, radius, 1, 0, alpha);
        vertex(vertexconsumer, posestack$pose, light, -radius, radius, 0, 0, alpha);
        poseStack.popPose();
